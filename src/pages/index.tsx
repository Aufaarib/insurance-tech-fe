...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center overflow-auto h-screen hidden-scrollbar">
          ...
          <div className="bg-[#f7f8fa] flex flex-col w-full justify-center items-center gap-[8px] rounded-[12px] pb-2">
            <div className="bg-white p-[16px] gap-[8px] w-full rounded-[12px]">
              <div className="grid grid-cols-3 gap-2">
                <div className="border-[1px] border-[#DAE0E9] w-full rounded-[8px] p-[8px] flex justify-center">
                  <Image
